...
=======
INSERT INTO `articles` (`id_post`, `titre_article`, `pseudo_auteur`, `descriptif_article`, `contenu`, `date_modification`, `image_article`) VALUES
...
=======
  ADD CONSTRAINT `id_article` FOREIGN KEY (`id_article`) REFERENCES `articles` (`id_post`) ON DELETE CASCADE ON UPDATE CASCADE;
>>>>>>> Stashed changes
COMMIT;
