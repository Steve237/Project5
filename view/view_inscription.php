                                        ...
                                        <form action="index.php?action=inscription" id="formInscription" method="post">
                                            ...
                                            <div class="row control-group">
                                                <div class="form-group col-xs-12 floating-label-form-group controls">
                                                    ...
                                                    <input required type="password" placeholder="Entrez votre mot de passe" name="password" 
                                                    class="form-control">
                                            ...
                                            <div class="row control-group">
                                                <div class="form-group col-xs-12 floating-label-form-group controls">
                                                    ...
                                                    <input required type="password" placeholder="Entrez votre mot de passe" name="password_confirm" 
                                                    class="form-control">
